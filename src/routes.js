...
// Test
const RoleTest = React.lazy(() => import('./views/test/RoleTest'))

// Main Operations
const Employees = React.lazy(() => import('./views/main-operations/employees/Employees'))
...
// Pages
const AccessDenied = React.lazy(() => import('./views/pages/access-denied/AccessDenied'))

// System Lookups
const DistrictsCenters = React.lazy(() => import('./views/system-lookups/DistrictsCenters'))
const Equipments = React.lazy(() => import('./views/system-lookups/Equipments'))
const Departments = React.lazy(() => import('./views/system-lookups/Departments'))
...
const routes = [
  ...
  { path: '/test/role-test', name: 'Role Test', element: RoleTest },
  { path: '/main-operations/employees', name: 'Employees', element: Employees },
  { path: '/profile/profile', name: 'Profile', element: Profile },
  { path: '/logout', name: 'Logout', element: Logout },
  { path: '/access-denied', name: 'Access Denied', element: AccessDenied },
  // System Lookups routes
  { path: '/system-lookups/districts-centers', name: 'Districts & Centers', element: DistrictsCenters },
  { path: '/system-lookups/equipments', name: 'Equipments', element: Equipments },
  { path: '/system-lookups/departments', name: 'Departments', element: Departments },
